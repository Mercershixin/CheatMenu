...
do
    ...
    function SYS.ResolveScanDir()
        ...
        local rel="CheatMenu\\"..safeFileName(nm)          -- ★ 文件夹名 = 服务器(游戏)的名字
        local who=tostring((SYS.LP and SYS.LP.Name) or "")
        local cands={
            "C:\\Users\\"..who.."\\Desktop\\"..rel,        -- ① Windows 用户名 = Roblox 名(常见)
            "C:\\Users\\Administrator\\Desktop\\"..rel,     -- ② 本机默认管理员(实测命中)
            "C:\\Users\\Public\\Desktop\\"..rel,            -- ③ 公共桌面
            "C:\\Users\\"..who.."\\OneDrive\\Desktop\\"..rel, -- ④ OneDrive 接管过的桌面
            rel,                                            -- ⑤ 退回执行器工作目录
        }
    ...
    -- 把缓冲到的全部扫描行, 按"十层"的分隔线拆成【每层一个 txt】+ 一个总览 txt
...
--  ══════════════════════════════════════════════════════════════
    ...
    function LAB.FullScan()
        ...
        -- ★★ v8.9.0 全部十层落盘到「桌面\CheatMenu\<服务器名>\」(每层一个 txt + 00_全部.txt)
        --   用户要求:「把全部抓到的 自动发到电脑桌面 然后文件夹是服务器的名字」
