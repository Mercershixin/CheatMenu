...
--   默认链(用户指定): 攻击我的 -> 最近 -> 屏幕中心。
--   无敌盾的人永远排最后(有别人可打就不打有盾的; 全服都有盾时照样选得到)。
local CB_CHAINS={
    [1]={"aiming","near","center"},   -- 攻击我的 -> 最近 -> 屏幕中心 (默认)
...
function CB.QuickMode()
    ...
    SYS.C_.CB_PrioMode=1   -- ★ v82: 一键开战默认优先链 = 攻击我的 -> 最近 -> 屏幕中心
...
local function CreateMenu()
    ...
    local function ApplyScale()
        P(function()
            ...
            local lo=DEV.small and 0.75 or 0.55        -- 触摸设备下限抬高(点得准)
            local hi=DEV.small and 1.25 or 1           -- 小屏允许放大(看得清)
